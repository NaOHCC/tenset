...
NETWORK_INFO_FOLDER = 'scripts/dataset/network_info'
TO_MEASURE_PROGRAM_FOLDER = 'scripts/dataset/to_measure_programs'
MEASURE_RECORD_FOLDER = 'scripts/dataset/measure_records'
